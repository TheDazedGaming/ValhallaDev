...
//    private static org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(AutobanManager.class);
	...
	if (this.points.get(acc) >= AUTOBAN_POINTS) {
		...
		cal.add(Calendar.DATE, 99999);
		c.getPlayer().tempban(banReason.toString(), cal, 1, false);
