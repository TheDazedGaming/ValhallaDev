...
public class DebugCommands implements Command {
	...
	public CommandDefinition[] getDefinition() {
		return new CommandDefinition[] {
			new CommandDefinition("resetquest", "", "", 100),
			new CommandDefinition("nearestPortal", "", "", 100),
			new CommandDefinition("spawndebug", "", "", 100),
			new CommandDefinition("timerdebug", "", "", 100),
			new CommandDefinition("threads", "", "", 100),
			new CommandDefinition("showtrace", "", "", 100),
			new CommandDefinition("toggleoffense", "", "", 100),
			new CommandDefinition("fakerelog", "", "", 100),
			...
			new CommandDefinition("givemonstatus", "", "", 100),
                        new CommandDefinition("sreactor", "[id]", "Spawn a Reactor", 100),
                        new CommandDefinition("hreactor", "[object ID]", "Hit reactor", 100),
                        new CommandDefinition("rreactor", "", "Resets all reactors", 100),
                        new CommandDefinition("lreactor", "", "List reactors", 100),
                        new CommandDefinition("dreactor", "", "Remove a Reactor", 100),
		};
	}
