...
public class ShutdownCommands implements Command {
	...
	public CommandDefinition[] getDefinition() {
		return new CommandDefinition[] {
			new CommandDefinition("shutdown", "[when in Minutes]", "Shuts down the current channel - don't use atm", 200),
			new CommandDefinition("shutdownnow", "", "Shuts down the current channel now", 200),
			new CommandDefinition("shutdownworld", "[when in Minutes]", "Cleanly shuts down all channels and the loginserver of this world", 200),
		};
	}
